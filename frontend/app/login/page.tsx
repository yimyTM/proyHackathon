...
export default function LoginPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    login(email || (role === "productor" ? "cooperativa@demo.com" : "comprador@demo.com"), role)
  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-background p-4">
      ...
      <div className="mb-8 flex items-center gap-3">
        ...
        <div>
          <h1 className="text-2xl font-bold text-foreground">TrazaAlimento</h1>
          <p className="text-sm text-muted-foreground">Trazabilidad alimentaria</p>
        </div>
      </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <Input
                id="email"
                type="email"
                placeholder={role === "productor" ? "cooperativa@demo.com" : "comprador@demo.com"}
                value={email}
      ...
      <p className="mt-6 text-center text-sm text-muted-foreground">
        Plataforma de trazabilidad para cooperativas agrícolas de Santa Cruz, Bolivia
      </p>
    </div>
  )
}
